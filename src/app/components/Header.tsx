  ...
  return (
    <nav>
      ...
      <div className="w-full bg-purple-600 text-white py-3">
        <div className="container mx-auto px-4 ml-40 flex justify-between items-center text-sm">
          <span>Sehrkhan873@gmail.com</span>
          <span>031456789</span>
          <div className="flex items-center gap-4  mr-20 text-sm">
          <span>English</span>
          <span>USD</span>
          <span>Login</span>
          <span>Wishlist</span>
      ...
      <div className="bg-white shadow-md">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          {/* Logo */}
          <h1 className="text-3xl font-bold text-black-600 ml-40">Hekto</h1>
