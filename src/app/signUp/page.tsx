...
function SignUp() {
  ...
  return (
    <div className="flex flex-col sm:flex-row min-h-screen">
      <div className="w-full sm:w-1/2 flex justify-center itemscenter  p-4"></div>
      ...
      <div className="w-full sm:w-1/2 flex justify-center items-center bg-white  p-6 sm:p-12">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              className="w-full px-6 py-2 bg-[#FB2E86] text-white font-semibold rounded-md hover:bg-red-600"
            >
              Create an Account
            </button>
