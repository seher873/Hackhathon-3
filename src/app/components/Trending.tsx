    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-50">
      <div className="w-full max-w-7xl flex flex-col gap-4 p-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="border border-gray-300 rounded-lg p-4 shadow-md text-center">
            <Image src="/box for image.png"width={50} height={50} alt="Product 3" className="w-[197px] h-[189px] mx-auto object-cover mb-2 rounded" />
            <p>Cantilever chair</p>
            <p>$26.00 $42.00</p>
          </div>
          <div className="border border-purple-200 rounded-lg p-4 shadow-md text-center">
            <Image src="/image 32 (1).png" width={50} height={50}alt="Product 4" className="w-[247px] h-[244px] mx-auto object-cover mb-2 rounded" />
            <p>Cantilever chair</p>
            <p>$26.00 $42.00</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="flex flex-col gap-2">
            <div className="bg-white border flex items-center gap-3 border-gray-300 rounded-lg p-2 shadow-sm">
              <Image src="/image 30 (1).png"width={50} height={50} alt="Side item 1" className="w-16 h-16 bg-gray-200 object-cover rounded" />
